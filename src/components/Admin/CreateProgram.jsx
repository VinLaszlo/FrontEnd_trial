...
const CreateProgram = () => {
  ...
  const { success, error } = useSelector((state) => state.programs);
  ...
  const handleSubmit = (e) => {
    ...
    newForm.append("adminId", owner._id);
    dispatch(
      createProgram({
        name,
        description,
  ...
  return (
    <div className="w-[90%] 800px:w-[50%] bg-white  shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label className="pb-2">
            Esemény leírása <span className="text-red-500">*</span>
          </label>
          <textarea
            cols="30"
            required
        ...
        <div>
          ...
          >
            <option value="Choose a category">Válaszd ki a kategóriát</option>
            {categoriesData &&
        ...
        <div>
          ...
          <input
            ...
            placeholder="Adj meg néhány taget"
          />
        </div>
        <br />
        <div>
          <label className="pb-2">
            Képek feltöltése <span className="text-red-500">*</span>
          </label>
          <input
            type="file"
            name=""
